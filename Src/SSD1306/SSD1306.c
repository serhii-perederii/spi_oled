...
#define __SSD1306_DC_CLR()  HAL_GPIO_WritePin(D_C_GPIO_Port, D_C_Pin, GPIO_PIN_RESET);
#define __SSD1306_DC_SET()  HAL_GPIO_WritePin(D_C_GPIO_Port, D_C_Pin, GPIO_PIN_SET);

#define __SSD1306_NRST_SET() HAL_GPIO_WritePin(DisplayReset_GPIO_Port, DisplayReset_Pin, GPIO_PIN_SET);
#define __SSD1306_NRST_RESET() HAL_GPIO_WritePin(DisplayReset_GPIO_Port, DisplayReset_Pin, GPIO_PIN_RESET);

#define __SSD1306_WRITE_BYTE(chData) HAL_SPI_Transmit_IT(&hspi2, &chData, 1);
/* Private define ------------------------------------------------------------*/
...
void ssd1306_init(void)
{
	...
	ssd1306_write_byte(0xA6, SSD1306_CMD);// Disable Inverse Display On (0xa6/a7)
        ...
        ssd1306_write_byte(0xF0, SSD1306_CMD);
